<template>
  <div class="ann-centered">
    ...
    <div id="wrapper">
      <div id="wheel" ref="red_wheel">
          <div id="inner-wheel">
              <div class="sec  sec_rd"></div>
              <div class="sec  sec_rd"></div>
              <div class="sec  sec_rd"></div>
              <div class="sec  sec_rd"></div>
              <div class="sec  sec_rd"></div>
  ...
  export default {
    ...
    methods: {
      ...
      spin(idOfSpinnerElement, interval) {
        ...
        let secs = document.getElementsByClassName('sec_rd')
        for (var i = 0; i < secs.length; i++) {
          if (!this.interrupted) {
            let t = this.$refs.red_wheel
            let noY = 0
            let c = 0
            let n = 700
        ...
        setTimeout(() => {
          ...
          if (this.countCLicks == 0 && !this.interrupted) {
            ...
            this.RDSetActiveFriend(randFriend)
            this.RDSetLoading(false)
          }
        },interval)
      }
